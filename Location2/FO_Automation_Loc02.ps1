...
$PrimaryHost = "HV-Host01-Loc2"
$SecondaryHost = "HV-Host01-Loc1"
$VmNames = @("VM01-Host01-Loc2", "VM02-Host01-Loc2", "VM03-Host01-Loc2", "VM04-Host01-Loc2", "VM05-Host01-Loc2") # Elenco delle VM da gestire
